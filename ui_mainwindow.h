...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        s_mainWindowGridLayout->setSpacing(5);
        s_mainWindowGridLayout->setObjectName(QStringLiteral("s_mainWindowGridLayout"));
        s_mainWindowGridLayout->setContentsMargins(12, 12, 12, 12);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        s_transformGB->setTitle(QApplication::translate("MainWindow", "GroupBox", 0));
        s_drawGB->setTitle(QApplication::translate("MainWindow", "GroupBox", 0));
    } // retranslateUi
